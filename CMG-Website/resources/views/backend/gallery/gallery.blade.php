    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 style="font-family: 'Mitr',sans-serif;">รูปภาพทั้งหมดในแกลเลอรี่</h2>
            </div>
            <div>
            ...
            <table id="gallery" class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="font-thai">หมวดหมู่รูป</th>
                    <th class="font-thai">รองหมวดหมู่รูป</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <form id="delete-form-{{ $images->id }}" action="{{ route('backend.gallery.destroy', $images->id) }}" method="post">
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn btn-danger" onclick="deleteRecord({{ $images->id }})"><span class="font-thai">ลบ</span></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
...
<script>
  ...
  Swal.fire({
    title: 'คุณแน่ใจว่าจะลบรูปภาพนี้หรือไม่?',
    text: `รูปนี้ '${id}' จะหายไปเมื่อคุณลบ!`,
    icon: 'warning',
