...
<head>
    ...
    <title>Backend - Add Employee</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="ename" class="font-thai">ชื่อของตำแหน่งงานที่จะเพิ่ม</label>
                            <br>
                        ...
                        <div class="form-group">
                            <label for="etotal" class="font-thai">จำนวนของคนในตำแหน่งงานที่จะเพิ่ม</label>
                            <br>
                            <input type="number" name="etotal" id="etotal">
                            @error('etotal')
                            <div class="alert alert-danger">
                            <span class="font-thai">กรุณากรอกจำนวนคนในตำแหน่งงานก่อน!</span>
                            </div>
                            @enderror
                        </div>
                    </div>
