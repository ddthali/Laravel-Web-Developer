    ...
    <div class="special"style="background-color: #B0C7DF;margin: 0;">
      ...
      <!-- <div id="cover-image" >
        <div class="text-headers">
            <span style="font-size: 90px;font-weight: bold;color: #6351ce;font-family: 'Aldrich', sans-serif;">CMG Engineering</span>
        </div>
        <div class="text-subtitle">
            <span style="font-size: 50px;color: blue;font-family: 'Manrope', sans-serif;">Change For the better</span>
        </div>
    </div> -->
        <div class="row gx-0 mb-5">
            <div class="col-lg-4">
            <div id="fbfanpage" class="Content-dark fb-page shadow-extra-large mt-4 " data-href="https://www.facebook.com/CMG.Eng.Con" data-tabs="timeline" data-width="" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/CMG.Eng.Con" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/CMG.Eng.Con">บริษัท ซีเอ็มจี เอ็นจิเนียริ่ง แอนด์ คอนสตรัคชั่น จำกัด</a></blockquote></div>
            </div>
            <div class="col-lg-8">
              <div id="aboutcmg" class="Content-dark container  p-4 mt-4 mb-3 rounded-3" style="max-width: 900px;">
              <br>
              ...
              <h5 class="text-center" style="font-weight: 600">CMG MANHOUR STATISTIC RECORD</h5>
              <h6 class="text-center" style="font-weight: 600">Man-hour up to date 10/6/16   Total  1,013,532  Hour.</h6>
              <br>
              <table class="table table-borderless table-responsive custom-hover">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td></td>
                        <td></td>
                        <th>Accident-free working hours</th>
                        <td class="text-center">{{ number_format($record->total) }}</td>
                        <td>Hours</td>
                      </tr>
                      @php
                          $total_h+=$record->total;
                      @endphp
                      @endforeach
                      </tbody>
                      <tfoot>
